...
#Author(s): Thomas S
#Date: 15 Aug 19
#Desc: This script parses the contents of the 'audit.txt' file generated by the script 'ansibleAdhoc.bash' in this directory, and it puts the result into an html report 'site_audit.html' for viewing. View site_audit.html for end result.
#import os
#os.system("./ansibleAdhoc.bash")

#declaration of variables
hospital="Sunny Brook Health" #hospital being audited
...
#open the site_audit.html file for writing, creates it if does not exist
file = open("site_audit.html","w+")

#insert the above code into the site_audit.html file
file.write(html_code_top)

#close the sites.html file
file.close()

#this function is called in main(), and it populates the table
...
#this file closed the html file after all information from the audit.txt file has been parsed
def closeHTMLFile():
...
def main():
        #open the ansible audit.txt file that has OS, Cache, and  Apache versions for all servers audited by ansible
